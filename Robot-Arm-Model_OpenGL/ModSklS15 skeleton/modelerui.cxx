...
// Load
PLYFile *p;
string addr = "E:\OpenGL-Project\assignment\sample_mesh.ply";
GLvoid display()
{
	//PLY display function
	p->PLYdisplay();
}
...
inline void ModelerUserInterface::cb_Load_i(Fl_Menu_*, void*) {
	char *filename = NULL;
	filename = fl_file_chooser("Load .ply File", "*.ply", NULL);

	if (filename)
	{
		ifstream ifs(filename);
		if (!ifs) {
			cerr << "Error: couldn't read PLY file " << filename << endl;
			return;
		}
...
void ModelerUserInterface::cb_Load(Fl_Menu_* o, void* v) {
	((ModelerUserInterface*)(o->parent()->user_data()))->cb_Load_i(o, v);
}
...
inline void ModelerUserInterface::cb_m_controlsAnimOnMenu_i(Fl_Menu_*, void*) {
  ...
  //KK_ANIMATING = ModelerApplication::Instance()->m_animating;// HERE ONCE HAS BEEN CHANGED!!!!
}
...
Fl_Menu_Item ModelerUserInterface::menu_m_controlsMenuBar[] = {
 ...
 {"Load PLY File", 0,  (Fl_Callback*)ModelerUserInterface::cb_Load, 0, 0, 0, 0, 14, 0},
